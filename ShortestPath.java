...
public class ShortestPath {
   ...
   public static void main(String[] args) throws IOException{
      ...
      try {
         ...
         if (intitalinput < 2) {
            System.err.println("Enter number greater than 2");
            System.exit(2);
         }
         else
            n = (int) intitalinput;
      ...
      while(true) {
         ...
         try {
            ...
            while(in.hasNextLine()) {
               ...
               int ds = Integer.parseInt(data[2]);
               if (ds < 0) {
                  System.out.println("Cost " + ds + " located at row " + rowNumber + " is invalid.");
                  topoStatus = false;
                  break;
               }
               cost[city][city2] = ds;
         ...
         if (!topoStatus) {
            System.out.print("Enter a new input file name: ");
